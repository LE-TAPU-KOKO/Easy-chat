...
class LoginUsernameActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        letMeInBtn.setOnClickListener((View.OnClickListener { v: View? ->
            setUsername()
        }))
    }
    ...
    fun setUsername() {
        ...
        if (userModel != null) {
            ...
            userModel = UserModel(phoneNumber, username, now.now(), FirebaseUtil.currentUserId())
        }
