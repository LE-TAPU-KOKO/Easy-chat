...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    /**
     * Dependency provider for <b>common</b> with <b>com.google.ai.client.generativeai:common</b> coordinates and
     ...
     */
    @Deprecated
    public static class FirebaseStorageKtxLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>v2101</b> with <b>com.google.firebase:firebase-storage-ktx</b> coordinates and
         * with version reference <b>firebaseStorageKtxVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getV2101() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("firebase.storage.ktx.v2101");
        }
    ...
    public static class FirebaseUiLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>firestore</b> with <b>com.firebaseui:firebase-ui-firestore</b> coordinates and
         * with version reference <b>firebaseUiFirestore</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getFirestore() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("firebase.ui.firestore");
        }
    ...
    public static class GlideLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        ...
        /**
         * Dependency provider for <b>v4160</b> with <b>com.github.bumptech.glide:glide</b> coordinates and
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>common</b> with value <b>0.10.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>firebaseBom</b> with value <b>31.3.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>firebaseMessagingKtx</b> with value <b>23.1.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>firebaseStorageKtx</b> with value <b>20.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>firebaseStorageKtxVersion</b> with value <b>21.0.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getFirebaseStorageKtxVersion() { return getVersion("firebaseStorageKtxVersion"); }

        /**
         * Version alias <b>firebaseUiFirestore</b> with value <b>8.0.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getFirebaseUiFirestore() { return getVersion("firebaseUiFirestore"); }
